      ...
      , methods = {
        init: function (opt) {
          this.each(function () {
              ...
              $spanLeft = $('<span></span>').addClass("labelLeft").text(options.label.enabled === undefined ? "开" : options.label.enabled);
              $spanRight = $('<span></span>').addClass("labelRight").text(options.label.disabled === undefined ? "关 " : options.label.disabled);
              ...
              $element
                .css('height', options.height - 5)
                .find('span, label')
                .css('height', options.height - 5)
                .filter('span')
                .css('line-height', (options.height - 5) + "px");
              ...
              $spanLeft.bind('click', function (e) {
                changeStatus($(this));
              });
              $spanRight.bind('click', function (e) {
                changeStatus($(this));
              });

              $element.find('input:checkbox').bind('change', function (e, skipOnChange) {
              ...
              $element.find('label').bind('mousedown touchstart', function (e) {
                moving = false;
                e.preventDefault();
